...
//            by JORGE NOCEDAL (July 1990)

// Modified to avoid need for f2c.h and libf2c.
...
/* Subroutine */ int lbfgs (integer *n, integer *m, doublereal *x, doublereal 
